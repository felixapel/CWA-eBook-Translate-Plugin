...
class CIContractTests(unittest.TestCase):
    ...
    def test_all_backend_contract_suites_are_required(self):
        for command in (
            ...
            "python3 -m unittest -v test_work_budget test_provider_budget test_cache_v2 test_context_cache test_singleflight test_auth test_ci_contract test_release_contract test_supply_chain_contract test_shell_contract test_container_contract test_cleanup_token test_api_schema test_error_privacy",
            "python3 -m py_compile auth.py server.py translator.py cache.py singleflight.py work_budget.py",
        ):
    ...
    def test_docker_smoke_exercises_the_published_proxy_path(self):
        ...
        self.assertIn("bt-ci-${{ github.run_id }}", self.workflow)

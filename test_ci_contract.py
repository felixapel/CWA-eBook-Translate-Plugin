...
class CIContractTests(unittest.TestCase):
    ...
    def test_all_backend_contract_suites_are_required(self):
        for command in (
            ...
            "python3 -m unittest -v test_work_budget test_provider_budget test_ci_contract test_release_contract test_cleanup_token test_api_schema test_error_privacy",
        ):

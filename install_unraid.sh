...
<Container version="2">
  ...
  <Config Name="Local LLM URL" Target="BT_LOCAL_URL" Default="http://YOUR-HOST-IP:1234/v1/chat/completions" Mode="" Description="OpenAI-compatible endpoint of your local LLM (only used when provider=local). Use your Unraid host IP, NOT localhost." Type="Variable" Display="always" Required="false" Mask="false">http://YOUR-HOST-IP:1234/v1/chat/completions</Config>
